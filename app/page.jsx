    ...
    <div>
     ...
     <section className="w-full py-12 md:py-24 lg:py-32 bg-background">
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 mx-auto md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl ">
          {
            features.map((feature,index)=>{
              return (
                ...
                >
                <CardContent
                className="pt-6 text-center items-center flex flex-col"
                >
     ...
     <div className="container mx-auto px-4 md:px-6">
      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 mx-auto md:grid-cols-3  gap-8 max-w-6xl ">
          {
     ...
     <div className=" mx-auto py-24 gradient rounded-lg max-w-4xl">
      <div className="flex flex-col items-center justify-center space-y-4 max-w-3xl text-center mx-auto ">
